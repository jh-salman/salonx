...
const DynamicCenterChart = () => {
  ...
  return (
    <svg viewBox="0 0 100 100" width="200" height="200">
      <circle cx="50" cy="50" r="40" stroke="#00f" strokeWidth="10" fill="none" />
      <circle
        cx="50"
        cy="50"
        r="40"
      ...
      />
      <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="#0ff" fontSize="14">
        {percentage}%
      </text>
    </svg>
  );
    ...
    return (
        <div>
            <svg width="293" height="297" viewBox="0 0 293 297" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <foreignObject x="70" y="90" width="150" height="150">
                  <DynamicCenterChart />
                </foreignObject>
